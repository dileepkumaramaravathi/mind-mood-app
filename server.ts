...
User text: "${text}"`;
    ...
    // Return standard fallback if API fails
    res.json({
      analysis: {
        emotion: 'Neutral',
        summary: 'Warm analysis could not be calculated dynamically. Your reflection seems valuable. Keep recording your feelings regularly.',
        suggestions: [
        ...
        quote: 'Owning our story and loving ourselves through that process is the bravest thing that we will ever do. — Brené Brown',
      },
    });
  }
});
...
Output your reply in structured JSON format.`,
    ...
    const fallbackText = "I am here for you. Recording how we feel is an brave step towards understanding ourselves. Take a deep breath: draw it in slowly, hold for four seconds, and let it go. Would you like to write about this in your daily journal?";
    ...
    res.json({
      ...
      analysis: {
        emotion: 'Neutral',
        copingTips: ['Breathe mindfully (inhale 4s, hold 4s, exhale 4s).', 'Write down a simple journal entry of what is causing this.'],
      },
    });
  }
});
